...
class ShowMeExpertSubCategoryScreen extends StatelessWidget {
  const ShowMeExpertSubCategoryScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final showMeExpertCategoryController = Get.find<ShowMeExpertCategoryController>();
    return Scaffold(
      appBar: customAppBar(
        context: context,
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Obx(() {
                    final categories =
                        showMeExpertCategoryController.subCategoryItems;
...
Future<void> continu(BuildContext context) async {
  ...
  if (showMeExpertCategoryController.selectedSubCategoryList.isEmpty) {
    bottomMessage(msg: "Please select your sub-category");
    return;
  }

    Get.toNamed(RoutesConstant.showMeExpertLearningStyleScreen);
