...
class ShowMeExpertCategoryScreen extends StatelessWidget {
  const ShowMeExpertCategoryScreen({super.key});
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Obx(() {
                    final categories =
                        showMeExpertCategoryController.allCategoryList;
...
Future<void> continu(BuildContext context) async {
  final showMeExpertCategoryController = Get.find<ShowMeExpertCategoryController>();
  if (showMeExpertCategoryController.selectedCategoryList.isEmpty) {
    bottomMessage(msg: "Please select your interests");
    return;
  }

  showMeExpertCategoryController.loadCategoryItems();

  Get.toNamed(RoutesConstant.showMeExpertSubCategoryScreen);
}
