...
class ConsulteePart extends StatefulWidget {
  const ConsulteePart({super.key});

  @override
  State<ConsulteePart> createState() => _ConsulteePartState();
}

class _ConsulteePartState extends State<ConsulteePart> {
