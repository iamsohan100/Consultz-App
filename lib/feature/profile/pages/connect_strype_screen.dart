...
class ConnectStripeScreen extends StatefulWidget {
  const ConnectStripeScreen({super.key});
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PrimaryButton(
                    onPressed: () async {
                      final url = await setBankController.connectStripe(
                        context,
                      );
                      if (url != null && url.isNotEmpty) {
                        Get.offNamed(
                          RoutesConstant.stripeWebviewScreen,
                          arguments: {'url': url, 'from': 'profile'},
                        );
                      }
                    },
                    title: setBankController.isConnected.value
                        ? 'Already Connected With Stripe'
                        : 'Connect with Stripe',
                  ),
