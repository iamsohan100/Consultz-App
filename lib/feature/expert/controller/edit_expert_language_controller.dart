...
class EditExpertLanguageController extends GetxController {

final List<String> selectedLanguageList = <String>[].obs;

final  selectedLanguage = 'Select your language'.obs;
  Future<bool> updateLanguage(BuildContext context) async {
    bool isSuccess = true;
    try {
      ...
      final response = await ApiCaller.putRequest(
        ...
        body: {
          "languages":selectedLanguageList,
        },
      );
