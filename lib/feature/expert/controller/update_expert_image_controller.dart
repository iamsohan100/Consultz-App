...
class UpdateExpertImageController extends GetxController {
  ...
  Future<bool> updateImage(BuildContext context) async {
    ...
    try {
      ...
      final response = await ApiCaller.formRequest(
        ...
        files: {"image": profileImge.value, 'cover': coverImage.value},

        fields: {'headline': headlineController.text.trim()},
      );
