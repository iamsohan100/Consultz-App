...
class SetExpertiseTimeZoneController extends GetxController {
  Rx<ExpertSetProfileModel> expertSetProfileModel = ExpertSetProfileModel().obs;

  final selectedTimeZone = 'Select a time zone'.obs;

  Future<bool> setTimeZone(BuildContext context) async {
    bool isSuccess = true;
    try {
      mainLoading(context, loadingText: 'Set time...');
