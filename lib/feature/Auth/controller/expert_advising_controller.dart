...
class ExpertAdvisingController extends GetxController {
  Rx<ExpertSetProfileModel> expertSetProfileModel = ExpertSetProfileModel().obs;

  RxList<String> selectedAdvisingStyles = <String>[].obs;
  Future<bool> setExpertAdvisingStyle(BuildContext context) async {
    bool isSuccess = true;
    ...
    try {
      ...
      final response = await ApiCaller.putRequest(
        ...
        body: {"advisingStyles": selectedAdvisingStyles},
      );
