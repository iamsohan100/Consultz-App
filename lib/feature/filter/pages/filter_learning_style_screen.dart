...
class FilterLearningStyleScreen extends StatelessWidget {
  const FilterLearningStyleScreen({super.key});
                    ...
                    children: [
                      for (int i = 0;
                        ...
                        InterestValueContainer(
                          ...
                          isSelected: filterController.selectedLearningStyles
                              .contains(InterestPageData.learningData[i]),
                          onTap: () => filterController.toggleLearningStyle(
